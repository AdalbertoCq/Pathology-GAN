...
from models.generative.gans.VAEGAN import VAEGAN
model = 'VAEGAN'
...
with tf.Graph().as_default():
    vaegan = VAEGAN(data=data, z_dim=z_dim, use_bn=use_bn, alpha=alpha, beta_1=beta_1, learning_rate_g=learning_rate_g, learning_rate_d=learning_rate_d, power_iterations=1, 
                	beta_2=beta_2, n_critic=n_critic, gp_coeff=gp_coeff, loss_type='relativistic standard gradient penalty')
    losses = vaegan.train(epochs, data_out_path, data, restore, n_images=10, show_epochs=None)
