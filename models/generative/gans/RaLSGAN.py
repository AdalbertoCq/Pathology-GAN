...
class RaLSGAN(GAN):
	def __init__(self, 
				...
				loss_type = 'relativistic least square',  # Loss function type: Standard, Least Square, Wasserstein, Wasserstein Gradient Penalty.				
				model_name='RaLSGAN'          			  # Name to give to the model.
				):
