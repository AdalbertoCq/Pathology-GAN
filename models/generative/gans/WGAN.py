...
class WGAN(GAN):
	def __init__(self, 
				...
				clipping,						   	 	# Clipping value for weights on the Discriminator, to ensure Lipschitz constrain.
				learning_rate_g,               			# Learning rate of the Generator.
				learning_rate_d,               			# Learning rate of the Discriminator.
				loss_type = 'wasserstein distance',     # Loss function type: Standard, Least Square, Wasserstein, Wasserstein Gradient Penalty.				
