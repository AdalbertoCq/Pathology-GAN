...
epochs         = 1
lr             = 1e-3
vars_job_id    = 'vae_se_densenet_ds_tran5'
restore        = False

# Parameters for Encoder.
enc_details = dict()
enc_details['enc_blocks']        = (2, 2)
enc_details['enc_growth_rates']  = (16, 16)
...
dec_details = dict()
dec_details['gen_blocks']        = (2, 2)
dec_details['gen_growth_rates']  = (16, 16)
