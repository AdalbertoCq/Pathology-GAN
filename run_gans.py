...
data = Data(dataset=dataset, marker=marker, patch_h=image_height, patch_w=image_width, n_channels=image_channels, batch_size=batch_size, labels=False)
...
with tf.Graph().as_default():
    ...
    losses = biggan.train(epochs, data_out_path, data, restore, n_images=10, show_epochs=None, evaluation=30)
